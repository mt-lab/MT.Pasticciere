...
class Cookie:
    def __init__(self, center=(0, 0), width=0, length=0, centerHeight=0, rotation=0, maxHeight=0, drawing=None):
        ...
        self.drawing = drawing  # dxf или ещё один класс под рисунок или набор точек рисунка (sliced) соответствующий ей
